...
from common.settings import Credentials
...
async def start(update: Update, context: CallbackContext) -> None:
    await update.message.reply_text('Привет! Я помогу тебе в удалении облаков со спутниковых фотографий. Отправь мне фотографию')
